...
import com.business.goldenfish.sidebar.allReports.AllReportAdapterNew;
...
public class LedgerReportActivity extends AppCompatActivity implements CommonInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        to_date_layout = findViewById(R.id.to_date_layout_ledger);
        tv_to_date = findViewById(R.id.tv_to_date_ledger);
        back_button=findViewById(R.id.back_button_ledger);
        tv_from_date = findViewById(R.id.tv_from_date_ledger);
        from_date_layout = findViewById(R.id.from_date_layout_ledger);
        viewPager = findViewById(R.id.viewPager_ledger);
        viewPager.setOffscreenPageLimit(1);
        tabLayout = findViewById(R.id.tabLayout_ledger);
        recycler_data=findViewById(R.id.recycler_data_ledger);
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_ledger);
        // toolbar.setTitle("");
                ...
                if (response.body() != null) {
                    ...
                    try {
                        ...
                        //    System.out.println("Req " + jsonObject);
                           ...
                           // System.out.println("Res " + allReports);
